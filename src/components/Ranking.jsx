  ...
  return (
    <div className="grid min-h-screen grid-col-3 justify-center bg-slate-100">
      <div className="group h-96 w-96 [perspective:1000px]">
        <div className="relative h-full w-full rounded-xl  transiti-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
          <div className="flex absolute inset-0 gap-5">
            
            <img
              className="h-full w-full  object-cover  shadow-black"
